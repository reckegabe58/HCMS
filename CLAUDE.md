...
- **Language and culture come first:** on every classroom page's "What We're Learning" subjects list, Oji-Cree Language must be the first entry, not buried in the middle. This applies to every classroom, current and future — check this when rebuilding or adding a classroom page.
