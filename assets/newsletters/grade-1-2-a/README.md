# Grade 1/2 A Newsletter Upload Guide

## Folder Location
`/assets/newsletters/grade-1-2-a/`
...
Open `/_classrooms/grade-1-2-a.md` and add a new entry at the **TOP** of the `newsletters:` list:

```yaml
newsletters:
  - month: "February 2025"                                      # Required
    title: "Reading Adventures"                                 # Optional
    file: /assets/newsletters/grade-1-2-a/2025-02-newsletter.pdf   # Required
...
```bash
git add assets/newsletters/grade-1-2-a/2025-02-newsletter.pdf
git add _classrooms/grade-1-2-a.md
git commit -m "Add February 2025 newsletter for Grade 1/2 A"
git push
```
