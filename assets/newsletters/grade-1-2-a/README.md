...
Save your file to: `/assets/newsletters/grade-1-2-a/`
...
## Commit & Push
```bash
git add assets/newsletters/grade-1-2-a/
git commit -m "Add newsletter for Grade 1/2 A"
git push
```
