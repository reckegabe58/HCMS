...
Save your file to: `/assets/newsletters/grade-7-8/`
...
## Commit & Push
```bash
git add assets/newsletters/grade-7-8/
git commit -m "Add newsletter for Grade 7/8"
git push
```
