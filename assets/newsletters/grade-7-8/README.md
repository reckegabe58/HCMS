# Grade 7/8 Newsletter Upload Guide

## Folder Location
`/assets/newsletters/grade-7-8/`
...
Open `/_classrooms/grade-7-8.md` and add a new entry at the **TOP** of the `newsletters:` list:

```yaml
newsletters:
  - month: "February 2025"                                    # Required
    title: "Preparing for High School"                        # Optional
    file: /assets/newsletters/grade-7-8/2025-02-newsletter.pdf   # Required
...
```bash
git add assets/newsletters/grade-7-8/2025-02-newsletter.pdf
git add _classrooms/grade-7-8.md
git commit -m "Add February 2025 newsletter for Grade 7/8"
git push
```
