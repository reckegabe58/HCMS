...
Save your file to: `/assets/newsletters/grade-5-6/`
...
## Commit & Push
```bash
git add assets/newsletters/grade-5-6/
git commit -m "Add newsletter for Grade 5/6"
git push
```
