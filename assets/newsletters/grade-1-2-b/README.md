# Grade 1/2 B Newsletter Upload Guide

## Folder Location
`/assets/newsletters/grade-1-2-b/`
...
Open `/_classrooms/grade-1-2-b.md` and add a new entry at the **TOP** of the `newsletters:` list:

```yaml
newsletters:
  - month: "February 2025"                                      # Required
    title: "Learning Together"                                  # Optional
    file: /assets/newsletters/grade-1-2-b/2025-02-newsletter.pdf   # Required
    type: pdf                                                   # Required: pdf, png, or jpg
    description: "This month we're working on..."               # Optional
  # ... existing newsletters below
```

### Step 3: Commit and push
```bash
git add assets/newsletters/grade-1-2-b/2025-02-newsletter.pdf
git add _classrooms/grade-1-2-b.md
git commit -m "Add February 2025 newsletter for Grade 1/2 B"
git push
```
