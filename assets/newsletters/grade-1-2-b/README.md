...
Save your file to: `/assets/newsletters/grade-1-2-b/`
...
## Commit & Push
```bash
git add assets/newsletters/grade-1-2-b/
git commit -m "Add newsletter for Grade 1/2 B"
git push
```
