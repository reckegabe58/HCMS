...
subjects:
  - name: Language Arts
    ...
    icon: book
  - name: Mathematics
    description: Basic operations, pre-algebra with variables and equations, geometry with proofs and spatial reasoning, and financial mathematics with real-life applications.
    icon: calculator
  - name: Science
    description: Land-based learning with hands-on activities, traditional Indigenous teachings combined with scientific methods of inquiry.
    icon: flask
  - name: Social Studies
  ...
  - name: Physical Education
    description: Volleyball, basketball, badminton, skating, hockey, snowshoeing, and gymnastics. Focus on healthy living, nutrition, and mental health.
    icon: heart
  - name: Cultural Leadership
    description: Elder mentorship, cultural teaching, language preservation with advanced Oji-Cree studies, and community service.
    icon: users
---
