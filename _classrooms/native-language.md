...
teacher_emails:
  - name: Ms. Brenda Daniels
    email: brenda.daniels@martenfalls.com
subjects:
  - name: Introductions & Greetings
    description: Learning to share their name, age, where they're from, and introduce family members in Oji-Cree.
    icon: message
  - name: Weather & Seasons
    description: Describing current weather and learning seasonal vocabulary throughout all four seasons.
    icon: globe
  - name: Nature & Animals
    description: Identifying and speaking words for animals, plants, and natural features found in the area.
    icon: tree
  - name: Daily Conversations
    description: Practicing conversational phrases and expressing feelings in Oji-Cree through songs, crafts, and interactive activities.
    icon: users
  - name: Cultural Learning
    description: Connecting language to the land, seasons, and Oji-Cree traditions with guidance from community Elders.
    icon: book
  - name: Family Connections
    description: Learning phrases to use at home and building language skills with family support.
    icon: heart
schedule:
  monday:
    - time: "10:00 - 10:30"
      activity: "Grade 1/2 Class A"
      details: ""
    - time: "10:30 - 11:00"
      activity: "Kindergarten"
      details: ""
    - time: "11:00 - 11:30"
      activity: "Grade 1/2 Class B"
      details: ""
    - time: "1:15 - 1:45"
      activity: "Grade 3/4"
      details: ""
...
**Boozhoo! Brenda indizhinikaaz**

Hello! I am Ms. Brenda. I am so honoured to share the Oji-Cree language with your children this year. Nurturing our identity together through language and culture is a blessing.
...
<div class="video-wrapper">
  <iframe src="https://www.youtube.com/embed/fq4n7-M25dc" title="Introducing Yourself in Oji-Cree" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
</div>
