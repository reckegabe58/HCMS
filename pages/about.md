...
title: About Us
permalink: /about/
hero_image: /assets/images/hero-banners/about-hero.jpg
...
<section class="page-hero-simple">
  <div class="page-hero-bg" style="background-image: url('{{ '/assets/images/hero-banners/about-hero.jpg' | relative_url }}');"></div>
      ...
      <div class="about-content">
        ...
        <div class="curriculum-grid">
          ...
          <div class="curriculum-item">
            <span class="curriculum-icon">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                ...
                <path d="M17 8c0-2.8-2.2-5-5-5S7 5.2 7 8c0 .4.1.9.2 1.3C5.3 10.1 4 11.9 4 14c0 2.8 2.2 5 5 5h6c2.8 0 5-2.2 5-5 0-2.1-1.3-3.9-3.2-4.7.1-.4.2-.9.2-1.3z"></path>
              </svg>
            </span>
          ...
          <div class="curriculum-item">
            <span class="curriculum-icon">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                <path d="M6 22V8a6 6 0 0 1 12 0v14"></path>
